...
export default {
    ...
    data() {
        const basedOnMyTasteSortObject = { type: 'custom-select', effect: 'sort-attribute', request: 'sort', attributes: ['Match Score', 'Top Rated', 'Most Popular', 'Newest'], items: ['Highest Matching Score', 'Top Rated', 'Most Popular', 'Newest'], default: 'Highest Matching Score', title: 'Sorting' }
        const popularTasteSortObject = { type: 'custom-select', effect: 'sort-attribute', request: 'sort', attributes: ['Top Rated', 'Most Popular', 'Newest'], items: ['Top Rated', 'Most Popular', 'Newest'], default: 'Most Popular', title: 'Sorting' }
        return {
        ...
        filters: {
            get() {
                return [
                    ...
                    { type: 'custom-multi-select', effect: 'filter-combination', request: 'genre_combination', attributes: ['All', ...this.seriesGenreCodes], items: ['All', ...this.seriesGenreNames], default: ['All'], title: 'Genre Combination' },
                    this.firstAirDateMinFilterObject,
                    this.firstAirDateMaxFilterObject,
